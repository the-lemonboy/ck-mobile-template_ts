...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    'communityDetail': RouteRecordInfo<'communityDetail', '/community/detail', Record<never, never>, Record<never, never>>,
    'waterfall': RouteRecordInfo<'waterfall', '/community/waterfall', Record<never, never>, Record<never, never>>,
